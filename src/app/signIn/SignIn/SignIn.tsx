...
const title = "Sign In";
const secondTitle = "Prove your talent on trading";
const text = "Trade with our simulated capital that can be allocated up to $200k Receive your payments bi-weekly"
...
export const SignIn = observer(() => {
    ...
    return (
        <div className={style.signIn}>
            ...
            <img src="/png/signIn/figure.png" alt="" className={style.figure}/>
            <div className={style.cloudsWrapper}>
                <CloudComponent seed={1} bound={24} segments={80}/>
            </div>
